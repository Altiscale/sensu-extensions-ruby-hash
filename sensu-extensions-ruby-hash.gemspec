...
Gem::Specification.new do |spec|
  spec.name          = "sensu-extensions-ruby-hash"
  spec.version       = "1.0.0"
  spec.authors       = ["Sensu-Extensions and contributors"]
  spec.email         = ["<sensu-users@googlegroups.com>"]

  spec.summary       = "The Sensu Core built-in ruby_hash mutator"
  spec.description   = "The Sensu Core built-in ruby_hash mutator"
  spec.homepage      = "https://github.com/sensu-extensions/sensu-extensions-ruby-hash"
